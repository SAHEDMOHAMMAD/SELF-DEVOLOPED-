...
playerB=createSprite(displayWidth-300,displayHeight/1)
...
playerC=createSprite(displayWidth-200,displayHeight/1)
...
playerD=createSprite(displayWidth-400,displayHeight/1)
...
playerE=createSprite(displayWidth-900,displayHeight/1)
...
invisibleTop=createSprite(287,341,3000,5)
...
bird=createSprite(180,153)
bird.addImage(birdImg)
bird.scale=0.1

birds=createSprite(1165,147)
birds.addImage(birdsImg)
birds.scale=0.1

birdss=createSprite(103,173)
birdss.addImage(birdssImg)
birdss.scale=0.1

birdsss=createSprite(224,232)
birdsss.addImage(birdsssImg)
birdsss.scale=0.1

birdssss=createSprite(1111,202)
birdssss.addImage(birdssssImg)
birdssss.scale=0.1

youWin=createSprite(400,120)
...
textSize (30) 
fill ("red")
text("Time Left :"+timer,displayWidth-500,100);
